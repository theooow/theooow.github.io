...
window.addEventListener("DOMContentLoaded", ()=>{
    ...
    miniTabs.forEach((tab, index)=>{
        tab.addEventListener("click", ()=>{
            ...
            const newData = (0, _dataJsonDefault.default).destinations.filter((planet)=>planet.name === title);
            // Change page content
            const image = document.querySelector(".image__planet");
            image.classList.forEach((className)=>{
                if (className !== "image__planet") image.classList.remove(className);
            });
    ...
    /* Circle tabs highlighter */ const circleTabs = document.querySelectorAll("circle");
    circleTabs.forEach((tab, index)=>{
        tab.addEventListener("click", ()=>{
            ...
            const newData = (0, _dataJsonDefault.default).crew.filter((crew)=>crew.name === hash);
            // Change page content
            ...
            crewImage.classList.forEach((className)=>{
                if (className !== "image__teammate") crewImage.classList.remove(className);
            });
            crewImage.classList.add(hash.replace(" ", "-"));
        });
    });
    /* Tab highlighter technology */ const techTabs = document.querySelectorAll(".circle");
    techTabs.forEach((tab, index)=>{
        tab.addEventListener("click", ()=>{
            ...
            tab.classList.add("active");
            const hash = tab.getAttribute("name").replace("-", " ");
            const newData = (0, _dataJsonDefault.default).technology.filter((tech)=>tech.name === hash);
            // Change page content
            ...
            techImage.classList.forEach((className)=>{
                if (className !== "tech-image") techImage.classList.remove(className);
            });
...
},{}]},["cvbMW","bAabt"], "bAabt", "parcelRequiree4ff")
